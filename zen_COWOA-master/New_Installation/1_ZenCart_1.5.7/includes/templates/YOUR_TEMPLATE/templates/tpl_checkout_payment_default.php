...
<?php if($COWOA) { ?>
    <div id="order_steps">
			...
			<span id="active_step_text_COWOA"><i class="fa fa-credit-card"></i><br /><?php echo TEXT_ORDER_STEPS_2; ?></span>
...
<?php } else { ?>
    <div id="order_steps">
			...
			<span id="active_step_text"><i class="fa fa-credit-card"></i><br /><?php echo TEXT_ORDER_STEPS_2; ?></span>
