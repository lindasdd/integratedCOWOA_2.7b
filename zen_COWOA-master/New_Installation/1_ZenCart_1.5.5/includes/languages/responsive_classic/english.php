...
// payment method is GV/Discount
  ...
  define('TEXT_VALID_COUPON', 'Congratulations you have redeemed the Gift Code. <br/><br/><strong>If your gift code applies to free shipping, the shipping method used will be ground shipping, regardless of the shipping method chosen during checkout.</strong>');
...
// more info in place of buy now
  ...
  define('MORE_PRODUCT_TEXT','... nutrition / ingredients / more');
...
// for all pages except where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', 'Successfully added Product to the cart ...Continue Shopping, Visit the <b><a href="index.php?main_page=shopping_cart">Shopping Cart</a></b> or go straight to <b><a href="index.php?main_page=checkout_shipping">Checkout</a></b>...');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', 'Successfully added Product to the cart ...Continue Shopping, Visit the <b><a href="index.php?main_page=shopping_cart">Shopping Cart</a></b> or go straight to <b><a href="index.php?main_page=checkout_shipping">Checkout</a></b>...');
