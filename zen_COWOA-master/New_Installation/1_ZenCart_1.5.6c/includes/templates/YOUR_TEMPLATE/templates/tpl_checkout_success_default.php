...
<?php if($COWOA) {?>
    <div id="order_steps">
			...
			<span class="order_steps_text4_COWOA"><i class="fa  fa-pencil-square"></i><br /><?php echo TEXT_ORDER_STEPS_3; ?></span>
			<span id="active_step_text_COWOA"><i class="fa fa-check"></i><br /><?php echo TEXT_ORDER_STEPS_4; ?></span>
            </div>
...
<?php } else {?>
    <div id="order_steps">
			...
			<span class="order_steps_text4"><i class="fa  fa-pencil-square"></i><br /><?php echo TEXT_ORDER_STEPS_3; ?></span>
			<span id="active_step_text"><i class="fa fa-check"></i><br /><?php echo TEXT_ORDER_STEPS_4; ?></span>
            </div>
             <div class="order_steps_line_2">
