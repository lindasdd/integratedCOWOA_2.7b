...
<?php if($COWOA) {?>
    <div id="order_steps">
			...
			<span id="active_step_text_COWOA"><i class="fa fa-truck"></i><br /><?php echo TEXT_ORDER_STEPS_1; ?></span>
			<span class="order_steps_text2_COWOA"><i class="fa fa-credit-card"></i><br /><?php echo TEXT_ORDER_STEPS_2; ?></span>
			<span class="order_steps_text3_COWOA"><i class="fa  fa-pencil-square"></i><br /><?php echo TEXT_ORDER_STEPS_3; ?></span>
...
<?php } else {?>
    <div id="order_steps">
            <div class="order_steps_text">
			<span id="active_step_text"><i class="fa fa-truck"></i><br /><?php echo TEXT_ORDER_STEPS_1; ?></span>
			<span class="order_steps_text2"><i class="fa fa-credit-card"></i><br /><?php echo TEXT_ORDER_STEPS_2; ?></span>
			<span class="order_steps_text3"><i class="fa  fa-pencil-square"></i><br /><?php echo TEXT_ORDER_STEPS_3; ?></span>
