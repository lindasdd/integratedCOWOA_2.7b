...
define('TEXT_SELECTED_BILLING_DESTINATION', '<ul class="fa-ul">Tips: <li><i class="fa fa-info-circle"></i> The billing address should match the address on your credit card statement.</li></ul>');
...
define('TABLE_HEADING_COMMENTS_EXPANDED', 'For carrier instructions, shipping date delays, or if the shipping address is unavailable on Friday or Saturdays - please include Comments below.');  
